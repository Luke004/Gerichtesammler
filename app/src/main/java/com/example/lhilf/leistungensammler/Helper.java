...
public class Helper {
    ...
    protected static int getOrientation(Context context, Uri photoUri) {
    ...
    protected static Bitmap getCorrectlyOrientedImage(Context context, Uri photoUri) throws IOException {
    ...
    static File createImageFile(Context ctx) throws IOException {
    ...
    public static int getMantissaMinutesOfDishDuration(float hours) {
        hours = hours % 1;
        return (int) (60 * hours);
    }
